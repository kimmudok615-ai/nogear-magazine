...
FACT 가 영어 논문 초록이면 한국어로 옮겨 쓴다. 연구 설계(메타분석·코호트 등)와 대상 수를 밝힌다.
...
잘 되는 훅 (2026-09 실측 상위 게시물)
- 목록형 약속: "○○가 절대 말 안 하는 3가지", "마지막이 제일 무섭다"
- 금지된 지식: "아무도 안 알려주는", "업계가 숨기는"
- 2인칭 경고: "당신이 ○○라면 이미 속고 있다"
- 한 장에 한 생각. 문장은 짧게 끊는다.

thread: 같은 내용을 스레드 글 한 장으로도 쓴다(8초 릴스용).
  title 한 줄 훅, items 번호 목록 4~6줄(각 40자 이내), outro 한 줄.

JSON 하나만 출력한다:
{"tag":"영문 대문자 태그","slides":[...],"caption":["첫 줄 훅","", "핵심 3줄", "", "출처: ..."],
 "thread":{"title":"...","items":["...","..."],"outro":"..."}}
"""
